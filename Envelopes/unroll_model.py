...
#
#   @ Get the envelope for WW Model Uncertainty
#
...
py6_unroll = get_unrolled("../MakeSelections/histfiles/py6_hists/final_pythia6_0jet.root","bdt_kAWW_0jet","py6")
amc_unroll = get_unrolled("../MakeSelections/histfiles/amc_hists/final_amcatnlo_0jet.root","bdt_kAWW_0jet","amcatnlo")  #### carefull about jets and bdt
her_unroll = get_unrolled("../MakeSelections/histfiles/her_hists/final_herwig_0jet.root","bdt_kAWW_0jet","herwig")
...
if do_full_log:
    fullLog=open('logs/spin2pkg1kq0_hpt300_1jet.dat','w')  #### change the name of the full log file
...
# --- write output file
if write_file:
    outfile = open('outFiles/WWModel/ww_model_spin2pkg1kq0_HPt300_1jet_v31.dat','w')  #### change the name of the file
...
if do_plot:
    ...
    canvas.SaveAs("outPlots/WWModel/ww_model_Spin2pkg1kq0_HPt300_1j.pdf")  #### change the name of the plot
